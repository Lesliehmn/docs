...
<Frame caption="Calendar Setup: To ensure your assistant can help visitors book appointments based on your actual availability, we recommend setting up your calendar schedule. This way, when your website goes live, Readdy Agent can automatically suggest available time slots based on your working hours.">
  <img
    src="/images/8ae52c51-1dbb-4877-b178-447c8277439c.png"
...
1. From the top navigation bar:
   ...
   Click `Readdy Agent` button at the top of the page

   图
2. From the `Integration` dropdown:

   Select `Readdy Agent`

   图
3. From the Project dropdown:

   Click `⋮` of current project → Select `Setting`

   <img
     src="/images/3f386c1f-f934-4226-ae86-f033edf56263.png"
     alt="3f386c1f F934 4226 Ae86 F033edf56263 Pn"
     title="3f386c1f F934 4226 Ae86 F033edf56263 Pn"
     style={{ width:"79%" }}
   />

In Project Settings, you can configure the Readdy Agent to:

- Set your working hours and calendar availability
- Customize AI prompts for chat and voice
- Adjust language, tone, and supported regions
- Add FAQs about your website and business to help guide Chat & Voice AI responses
...
![9ebedf26 Adb7 46b3 Ba09 58d24ab52ade Pn](/images/9ebedf26-adb7-46b3-ba09-58d24ab52ade.png)
...
> Decide how long each appointment will be.
...
#### Minimum Advance Booking Time (Optional)

> This setting controls how far in advance users must book an appointment.

- Default: Disabled.
  - When off, no restrictions are applied.
- When Enabled:
  - You can enter a value and choose the unit: Minute, Hour, or Day.
...
- **Appointment Tim**e – When the appointment is scheduled
...
| Status      | The current status of the session:\<br\> - New: Recently created lead\<br\> - Ongoing: Conversation in progress\<br\> - Ended: Interaction completed\<br\> - Error: Failed or incomplete session |
| Channel     | The type of interaction:\<br\> - Chat\<br\> - Voice                                                                                                                                              |
...
## Settings – Customize Your Readdy Agent
...
<Info>
  ...
  - A “message” refers to one interaction where the user sends a message and Readdy Agent responds or takes an action.
  - Most chat sessions typically consist of 2–4 messages.
</Info>
...
<Info>
  ...
  - All shared projects under the same account share the same usage quota.
</Info>
