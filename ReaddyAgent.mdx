...
You can add the Readdy Agent when creating a project or at any time afterward.
...
#### Add Through Integration Menu

Alternatively, you can also add the Readdy Agent from the navigation bar:

- From the `Integration` dropdown, select `Readdy Agent`
- This will automatically send the message: `“Add Readdy Agent to my project”` to the chat and begin the setup process.
...
1. From the top navigation bar: Click `Readdy Agent` button at the top of the page
   ...
   图
2. From the Project dropdown: Click `⋮` of current project → Select `Setting`
...
| Total Chats | For chat interactions: total number of message pairs                                |
...
### ⚠️ Keep Your Business Hour Consistent
